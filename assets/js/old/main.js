import Storehouse from './storehouse-shim.js';
...
const init = () => {
    ...
    const confirmationMessage = 'Tem certeza que deseja resetar? Suas alterações serão perdidas.';
    // default template
    const defaultInput = `# Guia de sintaxe Markdown
...
`;
    ...
    let setupEditor = () => {
        let editor = monaco.editor.create(document.querySelector('#editor'), {
            ...
            folding: false,
            contextmenu: false  // Desabilita menu de contexto em inglês
        });
    ...
    const PREVIEW_CSS_LIGHT = './assets/css/github-markdown-light.css?v=1.11.0';
    const PREVIEW_CSS_DARK = './assets/css/github-markdown-dark_dimmed.css?v=1.11.0';
    ...
    let copyToClipboard = (text, successHandler, errorHandler) => {
        // Verificar se a API Clipboard está disponível (requer HTTPS ou localhost)
    ...
    let notifyCopied = () => {
        ...
        labelElement.innerHTML = "Copiado!";
        setTimeout(() => {
            labelElement.innerHTML = "Copiar";
        }, 1000)
    };
